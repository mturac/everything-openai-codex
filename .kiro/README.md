# Everything OpenAI Codex for Kiro

Bring [Everything OpenAI Codex](https://github.com/openais/courses/tree/master/Everything OpenAI Codex) (ecc) workflows to [Kiro](https://kiro.dev). This repository provides custom agents, skills, hooks, steering files, and scripts that can be installed into any Kiro project with a single command.
