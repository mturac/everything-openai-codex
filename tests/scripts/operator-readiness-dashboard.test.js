...
function seedRepo(rootDir, overrides = {}) {
  const files = {
    ...
    'docs/releases/2.0.0-rc.1/publication-readiness.md': 'Codex plugin Codex plugin',
    'docs/releases/2.0.0-rc.1/naming-and-publication-matrix.md': 'Codex plugin Codex plugin npm package Publication Paths',
