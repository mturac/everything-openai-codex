#!/usr/bin/env node
/**
 * Cursor-to-OpenAI Codex Hook Adapter
 * Transforms Cursor stdin JSON to OpenAI Codex hook format,
...
function transformToCodex(cursorInput, overrides = {}) {
  return {
    tool_input: {
...
module.exports = { readStdin, getPluginRoot, transformToCodex, runExistingHook, hookEnabled };
