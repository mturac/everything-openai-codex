...
Common issues and solutions for Everything OpenAI Codex (ecc) plugin.
...
# Use OpenAI Codex: "New Chat" or Cmd/Ctrl+Shift+N
...
ls ~/.codex/agents/  # Custom agents only
...
# Disable and re-enable plugin in OpenAI Codex settings
```
...
# Edit ~/.codex/settings.json and remove pre-bash hook
```
...
- OpenAI Codex version incompatibility
- Corrupted plugin files
- Local Codex setup was wiped or reset
...
# Edit ~/.codex/settings.json

# Keep active observation files small
# Large archives should live under ~/.codex/homunculus/archive/
```

### High CPU Usage

**Symptom:** OpenAI Codex consuming 100% CPU
...
1. **Check GitHub Issues**: [github.com/mehmet-turac/everything-openai-codex/issues](https://github.com/mehmet-turac/everything-openai-codex/issues)
