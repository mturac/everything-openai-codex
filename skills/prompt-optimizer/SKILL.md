...
- User says "what's the best way to ask OpenAI Codex to..."
...
|-------|------------------|-----------|
| TRIVIAL-LOW | Standard 4.6 | Fast, cost-efficient for simple tasks |
| MEDIUM | Standard 4.6 | Best coding model for standard work |
| HIGH | Standard 4.6 (main) + Deep 4.6 (planning) | Deep for architecture, Standard for implementation |
| EPIC | Deep 4.6 (blueprint) + Standard 4.6 (execution) | Deep reasoning for multi-session planning |
...
| Model | Standard 4.6 | Recommended for this scope |
...
- "Rewrite this prompt so OpenAI Codex uses the right commands"
- "帮我优化这个指令"
...
Recommended: Deep 4.6 for blueprint planning, Standard 4.6 for phase execution.
```
