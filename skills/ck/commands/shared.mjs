...
export const CK_HOME          = resolve(homedir(), '.codex/ck');
...
export const SKILL_FILE       = resolve(homedir(), '.codex/ck', 'SKILL.md');
...
export function nativeMemoryDir(absolutePath) {
  ...
  return resolve(homedir(), '.codex/projects', encoded, 'memory');
}
