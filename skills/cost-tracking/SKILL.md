---
name: cost-tracking
description: Track and report OpenAI Codex token usage, spending, and budgets from a local cost-tracking database. Use when the user asks about costs, spending, usage, tokens, budgets, or cost breakdowns by project, tool, session, or date.
origin: community
---

# Cost Tracking

Use this skill to analyze OpenAI Codex cost and usage history from a local SQLite
...
| `session_id` | OpenAI Codex session identifier |
