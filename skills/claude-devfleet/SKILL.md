...
Use this skill when you need to dispatch multiple OpenAI Codex agents to work on coding tasks in parallel. Each agent runs in an isolated git worktree with full tooling.

Requires a running Codex DevFleet instance connected via MCP:
```bash
