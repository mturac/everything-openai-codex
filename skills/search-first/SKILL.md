...
| Skills directory | `ls ~/.codex/skills ~/.codex/skills` where applicable | Say no local skill catalog was available |
...
Agent(subagent_type="general-purpose", prompt="
  ...
  Search: npm/PyPI, MCP servers, OpenAI Codex skills, GitHub
  Return: Structured comparison with recommendation
")
```

Older OpenAI Codex docs may call this `Task(...)`; use the current agent/subagent
