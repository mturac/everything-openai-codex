...
description: "GAN-inspired Generator-Evaluator agent harness for building high-quality applications autonomously. Based on OpenAI's March 2026 harness design paper."
...
> Inspired by [OpenAI's Harness Design for Long-Running Application Development](https://www.openai.com/engineering/harness-design-long-running-apps) (March 24, 2026)
...
**Model:** Deep 4.6 (needs deep reasoning for spec expansion)
...
**Model:** Deep 4.6 (needs strong coding capability)
...
**Model:** Deep 4.6 (needs strong judgment + tool use)
...
```bash
# Step 1: Plan
codex -p --model deep "You are a Product Planner. Read PLANNER_PROMPT.md. Expand this brief into a full product spec: 'Build a Kanban board app'. Write spec to spec.md"

# Step 2: Generate (iteration 1)
codex -p --model deep "You are a Generator. Read spec.md. Implement Sprint 1. Start the dev server on port 3000."

# Step 3: Evaluate (iteration 1)
codex -p --model deep --allowedTools "Read,Bash,mcp__playwright__*" "You are an Evaluator. Read EVALUATOR_PROMPT.md. Test the live app at http://localhost:3000. Score against the rubric. Write feedback to feedback-001.md"

# Step 4: Generate (iteration 2 — reads feedback)
codex -p --model deep "You are a Generator. Read spec.md and feedback-001.md. Address all issues. Improve the scores."
...
The harness should simplify as models improve. Following OpenAI's evolution:

### Stage 1 — Weaker Models (Standard-class)
...
### Stage 2 — Capable Models (Deep 4.5-class)
...
### Stage 3 — Frontier Models (Deep 4.6-class)
...
| `GAN_PLANNER_MODEL` | `deep` | Model for planning agent |
| `GAN_GENERATOR_MODEL` | `deep` | Model for generator agent |
| `GAN_EVALUATOR_MODEL` | `deep` | Model for evaluator agent |
...
Based on OpenAI's published results:
...
- [OpenAI: Harness Design for Long-Running Apps](https://www.openai.com/engineering/harness-design-long-running-apps) — Original paper by Prithvi Rajasekaran
- [Epsilla: The GAN-Style Agent Loop](https://www.epsilla.com/blogs/openai-harness-engineering-multi-agent-gan-architecture) — Architecture deconstruction
