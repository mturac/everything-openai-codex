...
Safely open-source any project through a 3-stage pipeline: **Fork** (strip secrets) → **Sanitize** (verify clean) → **Package** (CODEX.md + setup.sh + README).
...
| `/opensource package PROJECT` | Generate CODEX.md + setup.sh + README |
...
Generate:
1. CODEX.md (commands, architecture, key files)
...
Show each project with pipeline progress (FORK_REPORT.md, SANITIZATION_REPORT.md, CODEX.md presence).
