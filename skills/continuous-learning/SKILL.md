...
Automatically evaluates OpenAI Codex sessions on end to extract reusable patterns that can be saved as learned skills.

## When to Activate

- Setting up automatic pattern extraction from OpenAI Codex sessions
...
- [The Longform Guide](https://x.com/mehmet_turac/status/2014040193557471352) - Section on continuous learning
...
2. **Background observer** - Fast agent analyzing in parallel
