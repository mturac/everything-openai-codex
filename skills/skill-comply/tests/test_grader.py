...
def _mock_compliant_classification(spec, trace, model="fast"):  # noqa: ARG001
...
def _mock_noncompliant_classification(spec, trace, model="fast"):
...
def _mock_empty_classification(spec, trace, model="fast"):
    return {}
