---
name: observer
description: Background agent that analyzes session observations to detect patterns and create instincts. Uses Fast for cost-efficiency. v2.1 adds project-scoped instincts.
model: fast
---

# Observer Agent

A background agent that analyzes observations from OpenAI Codex sessions to detect patterns and create instincts.
