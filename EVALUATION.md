...
**Date:** 2026-03-21
**Branch:** `codex/evaluate-repo-comparison-ASZ9Y`

---

## Current Setup (`~/.codex/`)

The active OpenAI Codex installation is near-minimal:
...
## This Repo (`Everything OpenAI Codex` v1.9.0)
...
| Supported harnesses | OpenAI Codex, Codex, Cursor, OpenCode |
...
- AI/ML workflows (Codex API, eval harness, agent loops, cost-aware pipelines)
