# Everything OpenAI Codex for Trae

Bring Everything OpenAI Codex (ecc) workflows to Trae IDE. This repository provides custom commands, agents, skills, and rules that can be installed into any Trae project with a single command.
