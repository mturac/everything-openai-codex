...
function usage() {
  console.log([
    ...
    '  node scripts/orchestration-status.js .codex/plan/workflow-visual-proof.json',
    '  node scripts/orchestration-status.js .codex/plan/workflow-visual-proof.json --write /tmp/snapshot.json'
  ].join('\n'));
}
