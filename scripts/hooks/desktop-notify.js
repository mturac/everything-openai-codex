 ...
 *
 * Sends a native desktop notification with the task summary when Codex
 ...
 * focuses the iTerm2 tab where OpenAI Codex runs. Outside iTerm2, falls back
 ...
 * OpenAI Codex process still owns the terminal emulator's tty (e.g. iTerm2 tab).
 ...
 * exact iTerm2 tab where OpenAI Codex is running. The default osascript path
