...
async function resolveSessionId() {
  // OpenAI Codex passes hook input via stdin JSON; session_id is the
  ...
  return process.env.CODEX_SESSION_ID || 'default';
}
...
async function main() {
  ...
  //
  // log() writes to stderr (debug log). Per the OpenAI Codex hooks guide,
