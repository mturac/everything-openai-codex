 ...
 * "SessionStart:startup hook error" to appear in the OpenAI Codex CLI header.
 *
 ...
 *
 * How it works:
 *   1. Reads the raw JSON event from stdin (passed by OpenAI Codex).
 *   2. Resolves the ecc plugin root directory (via CODEX_PLUGIN_ROOT env var
 ...
 *      through unchanged so OpenAI Codex can continue normally.
 */
...
function resolvePluginRoot() {
  const envRoot = process.env.CODEX_PLUGIN_ROOT || '';
