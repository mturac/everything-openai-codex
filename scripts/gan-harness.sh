...
#
# Inspired by OpenAI's "Harness Design for Long-Running Application Development"
# https://www.openai.com/engineering/harness-design-long-running-apps
#
# Usage:
...
#   GAN_PLANNER_MODEL   — Model for planner (default: deep)
#   GAN_GENERATOR_MODEL — Model for generator (default: deep)
#   GAN_EVALUATOR_MODEL — Model for evaluator (default: deep)
...
PLANNER_MODEL="${GAN_PLANNER_MODEL:-deep}"
GENERATOR_MODEL="${GAN_GENERATOR_MODEL:-deep}"
EVALUATOR_MODEL="${GAN_EVALUATOR_MODEL:-deep}"
