...
const SUPPORTED_INSTALL_TARGETS = ['codex', 'cursor', 'antigravity', 'codex', 'gemini', 'opencode', 'codebuddy', 'joycode', 'qwen', 'zed'];
...
function resolveLegacyCompatibilitySelection(options = {}) {
  ...
  const baseModuleIds = LEGACY_COMPAT_BASE_MODULE_IDS_BY_TARGET[target || 'codex']
    || LEGACY_COMPAT_BASE_MODULE_IDS_BY_TARGET.codex;
