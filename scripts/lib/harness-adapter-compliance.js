...
const ADAPTER_RECORDS = Object.freeze([
  {
    ...
    unsupported_surfaces: ['Codex-native hooks do not imply parity in other harnesses'],
    install_or_onramp: [
  ...
  },
  {
    ...
    unsupported_surfaces: ['Native hook enforcement and Codex slash-command semantics are not equivalent'],
    install_or_onramp: [
      '`./install.sh --profile minimal --target codex`',
  ...
  },
  {
    ...
    unsupported_surfaces: ['Event names, plugin packaging, and command dispatch differ from OpenAI Codex'],
  ...
  },
  {
    ...
    unsupported_surfaces: ['Cursor hook events and rule loading differ from OpenAI Codex'],
  ...
  },
  {
    ...
    unsupported_surfaces: ['Zed external agents and native Agent Panel permissions are not Codex hooks'],
