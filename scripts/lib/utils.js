...
function getSessionsDir() {
  return path.join(getCodexDir(), SESSION_DATA_DIR_NAME);
}
...
function getLegacySessionsDir() {
  return path.join(getCodexDir(), LEGACY_SESSIONS_DIR_NAME);
}
 ...
 * like ".codex" map cleanly to "codex".
 *
...
/**
 * Log to stderr (visible to user in OpenAI Codex)
 */
