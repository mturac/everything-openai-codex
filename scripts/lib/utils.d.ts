/**
 * Cross-platform utility functions for OpenAI Codex hooks and scripts.
...
/** Get the canonical ecc sessions directory (~/.codex/session-data) */
export function getSessionsDir(): string;

/** Get the legacy Codex-managed sessions directory (~/.codex/sessions) */
...
/** Log a message to stderr (visible to user in OpenAI Codex terminal) */
