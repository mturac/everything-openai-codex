...
const CURRENT_PLUGIN_SLUG = 'eoc';
const PREVIOUS_PLUGIN_SLUG = 'ecc';
const LEGACY_PLUGIN_SLUG = 'everything-openai-codex';
const CURRENT_PLUGIN_HANDLE = `${CURRENT_PLUGIN_SLUG}@${CURRENT_PLUGIN_SLUG}`;
const PREVIOUS_PLUGIN_HANDLE = `${PREVIOUS_PLUGIN_SLUG}@${PREVIOUS_PLUGIN_SLUG}`;
const LEGACY_PLUGIN_HANDLE = `${LEGACY_PLUGIN_SLUG}@${LEGACY_PLUGIN_SLUG}`;
const PLUGIN_CACHE_SLUGS = [CURRENT_PLUGIN_SLUG, PREVIOUS_PLUGIN_SLUG, LEGACY_PLUGIN_SLUG];
const PLUGIN_ROOT_SEGMENTS = [
  [CURRENT_PLUGIN_SLUG],
  [CURRENT_PLUGIN_HANDLE],
  ['marketplaces', CURRENT_PLUGIN_SLUG],
  [PREVIOUS_PLUGIN_SLUG],
  [PREVIOUS_PLUGIN_HANDLE],
  ['marketplaces', PREVIOUS_PLUGIN_SLUG],
  [PREVIOUS_PLUGIN_SLUG, LEGACY_PLUGIN_SLUG],
