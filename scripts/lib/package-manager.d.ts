 ...
 * 2. Project-specific config (.codex/package-manager.json)
 * 3. package.json `packageManager` field
 * 4. Lock file detection
 * 5. Global user preference (~/.codex/package-manager.json)
 ...
 * Saves to ~/.codex/package-manager.json.
 ...
 * Saves to <projectDir>/.codex/package-manager.json.
