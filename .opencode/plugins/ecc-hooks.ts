/**
 * Everything OpenAI Codex (ecc) Plugin Hooks for OpenCode
 *
 * This plugin translates OpenAI Codex hooks to OpenCode's plugin system.
 * OpenCode's plugin system is MORE sophisticated than OpenAI Codex with 20+ events
 * compared to OpenAI Codex's 3 phases (PreToolUse, PostToolUse, Stop).
 *
 * Hook Event Mapping:
...
export const eccHooksPlugin: eccHooksPluginFn = async ({
  ...
  return {
     ...
     * Equivalent to OpenAI Codex PostToolUse hook for prettier
     *
     ...
     * Equivalent to OpenAI Codex PostToolUse hook for tsc
     *
     ...
     * Equivalent to OpenAI Codex PreToolUse hook
     *
     ...
     * Equivalent to OpenAI Codex SessionStart hook
     *
    ...
    "session.created": async () => {
      ...
      if (hasProjectFile("CODEX.md")) {
        log("info", "[ecc] Found CODEX.md - loading project context")
      }
    },

    /**
     * Session Idle Hook
     * Equivalent to OpenAI Codex Stop hook
     *
     ...
     * Equivalent to OpenAI Codex SessionEnd hook
     *
    ...
    "experimental.session.compacting": async () => {
      const contextBlock = [
        ...
        "",
        "## Active Plugin: Everything OpenAI Codex v2.0.0-rc.1",
