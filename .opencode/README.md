...
Everything OpenAI Codex (ecc) plugin for OpenCode - agents, commands, hooks, and skills.

## Installation

## Installation Overview

There are two ways to use Everything OpenAI Codex (ecc):
...
OpenCode's plugin system maps to OpenAI Codex hooks:
...
OpenCode has 20+ additional events not available in OpenAI Codex.

### Hook Runtime Controls

OpenCode plugin hooks honor the same runtime controls used by OpenAI Codex/Cursor:
...
```json
{
  ...
  "small_model": "openai/codex-haiku-4-5",
  "plugin": ["./plugins"],
  "instructions": [
