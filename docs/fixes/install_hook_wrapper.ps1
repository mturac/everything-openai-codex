...
$SkillHooks   = "$env:USERPROFILE\.codex\skills\continuous-learning\hooks"
$WrapperSrc   = Join-Path $PSScriptRoot "observe-wrapper.sh"
$WrapperDst   = "$SkillHooks\observe-wrapper.sh"
$SettingsPath = "$env:USERPROFILE\.codex\settings.local.json"
# Use PATH-resolved `bash` to avoid OpenAI Codex v2.1.116 argv-dup bug that
...
Write-Host "Next: Launch Codex CLI and run any command to trigger observations.jsonl"
