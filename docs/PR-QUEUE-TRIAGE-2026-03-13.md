...
`Everything OpenAI Codex` pull-request queue as of `2026-03-13T08:33:31Z`.
...
2. Low: the new guard matrix shipped without direct regression coverage.
   ...
   directly assert the new `CODEX_ENTRYPOINT`, `ecc_HOOK_PROFILE`,
...
| `#336` | `Customisation for Codex CLI - Features from OpenAI Codex and OpenCode` | `true` | `MERGEABLE` | `UNSTABLE` | `2026-03-13T07:26:12Z` | `No` | `Needs manual review and draft exit` |
