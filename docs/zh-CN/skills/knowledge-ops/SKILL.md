...
### 第二层：OpenAI Codex 记忆（快速访问）

* **路径：** `~/.codex/projects/*/memory/`
...
# 中期：项目记忆文件
写入 ~/.codex/projects/*/memory/ 以实现跨会话回溯
