...
使用 [AgentShield](https://github.com/mehmet-turac/agentshield) 审计您的 OpenAI Codex 配置中的安全问题。

## 何时激活

* 设置新的 OpenAI Codex 项目时
* 修改 `.codex/settings.json`、`CODEX.md` 或 MCP 配置后
* 提交配置更改前
* 加入具有现有 OpenAI Codex 配置的新代码库时
* 定期进行安全卫生检查时
