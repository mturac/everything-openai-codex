...
description: "受GAN启发的生成器-评估器代理框架，用于自主构建高质量应用。基于OpenAI 2026年3月的框架设计论文。"
...
> 灵感来源于 [OpenAI 的长时间运行应用开发编排设计](https://www.openai.com/engineering/harness-design-long-running-apps)（2026年3月24日）
...
编排应随模型改进而简化。遵循 OpenAI 的演进路径：

### 阶段 1 — 较弱模型（Standard 级别）
...
| `GAN_PLANNER_MODEL` | `deep` | 规划智能体的模型 |
| `GAN_GENERATOR_MODEL` | `deep` | 生成器智能体的模型 |
| `GAN_EVALUATOR_MODEL` | `deep` | 评估器智能体的模型 |
...
6. **上下文耗尽**——对于长时间会话，使用 Codex Agent SDK 的自动压缩或在主要阶段之间重置上下文。
...
* [OpenAI：长时间运行应用的编排设计](https://www.openai.com/engineering/harness-design-long-running-apps) — Prithvi Rajasekaran 的原始论文
* [Epsilla：GAN 风格智能体循环](https://www.epsilla.com/blogs/openai-harness-engineering-multi-agent-gan-architecture) — 架构解构
