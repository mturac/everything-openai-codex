...
description: 自动从OpenAI Codex会话中提取可重复使用的模式，并将其保存为学习到的技能以供将来使用。
origin: ecc
---

# 持续学习技能

自动评估 OpenAI Codex 会话的结尾，以提取可重用的模式，这些模式可以保存为学习到的技能。

## 何时激活

* 设置从 OpenAI Codex 会话中自动提取模式
* 为会话评估配置停止钩子
* 在 `~/.codex/skills/learned/` 中审查或整理已学习的技能
* 调整提取阈值或模式类别
...
* [长篇指南](https://x.com/mehmet_turac/status/2014040193557471352) - 关于持续学习的章节
* `/learn` 命令 - 在会话中手动提取模式
