...
description: 审计活跃仓库、MCP服务器、插件、连接器、环境表面和工具设置，然后推荐最高价值的ecc原生技能、钩子、代理和操作员工作流。当用户希望帮助设置OpenAI Codex或了解其环境中实际可用的功能时使用。
origin: ecc
---
...
* 用户说"设置 OpenAI Codex"、"推荐自动化"、"我应该使用什么插件或 MCP？"或"我缺少什么？"
...
* 与设置、审查、文档、设计或工作流质量重叠的官方 Codex 插件
* Codex 或 Codex 中本地安装的插件
* 用户当前连接的应用表面
