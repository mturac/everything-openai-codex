...
**输出路径**：`.codex/PRPs/prds/{kebab-case-name}.prd.md`

如果需要，创建目录：`mkdir -p .codex/PRPs/prds`
...
**文件**：`.codex/PRPs/prds/{name}.prd.md`
...
运行：`/prp-plan .codex/PRPs/prds/{name}.prd.md`
