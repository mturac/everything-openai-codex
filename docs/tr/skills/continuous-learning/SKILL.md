...
description: OpenAI Codex oturumlarından yeniden kullanılabilir kalıpları otomatik olarak çıkarın ve gelecekte kullanmak üzere öğrenilmiş skill'ler olarak kaydedin.
origin: ecc
---

# Sürekli Öğrenme Skill'i

OpenAI Codex oturumlarını sonunda otomatik olarak değerlendirir ve öğrenilmiş skill'ler olarak kaydedilebilecek yeniden kullanılabilir kalıpları çıkarır.

## Ne Zaman Aktifleştirmelisiniz

- OpenAI Codex oturumlarından otomatik kalıp çıkarma ayarlarken
- Oturum değerlendirmesi için Stop hook'u yapılandırırken
- `~/.codex/skills/learned/` içindeki öğrenilmiş skill'leri incelerken veya düzenlerken
...
3. **Skill Çıkarma**: Yararlı kalıpları `~/.codex/skills/learned/` dizinine kaydeder
...
2. **Arka plan gözlemcisi** - Paralel analiz yapan Fast agent'ı
