---
name: eval-harness
description: Eval-driven development (EDD) ilkelerini uygulayan OpenAI Codex oturumları için formal değerlendirme çerçevesi
origin: ecc
...
OpenAI Codex oturumları için eval-driven development (EDD) ilkelerini uygulayan formal değerlendirme çerçevesi.

## Ne Zaman Aktifleştirmeli

- AI destekli iş akışları için eval-driven development (EDD) kurarken
- OpenAI Codex görev tamamlama için geçti/kaldı kriterleri tanımlarken
...
Codex'un daha önce yapamadığı bir şeyi yapıp yapamadığını test et:
```markdown
[CAPABILITY EVAL: feature-name]
Görev: Codex'un başarması gereken şeyin açıklaması
Başarı Kriterleri:
  - [ ] Kriter 1
  - [ ] Kriter 2
  - [ ] Kriter 3
...
Açık uçlu çıktıları değerlendirmek için Codex kullan:
```markdown
[MODEL GRADER PROMPT]
...
```
`.codex/evals/feature-name.md` konumunda eval tanım dosyası oluşturur
...
- `.codex/evals/<feature>.md` tanımı
- `.codex/evals/<feature>.log` çalıştırma geçmişi
