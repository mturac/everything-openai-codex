...
*Burada yer almak için [Kurumsal sponsor](https://github.com/sponsors/mehmet-turac) olun*

## İşletme Sponsorları

*Burada yer almak için [İşletme sponsoru](https://github.com/sponsors/mehmet-turac) olun*

## Takım Sponsorları

*Burada yer almak için [Takım sponsoru](https://github.com/sponsors/mehmet-turac) olun*

## Bireysel Sponsorlar

*Burada listelenmek için [sponsor](https://github.com/sponsors/mehmet-turac) olun*
...
- `@mturac/eoc` ve `ecc-agentshield` için canlı npm kurulum/indirme metrikleri
...
- Harness'lar arası destek: OpenAI Codex, Cursor, OpenCode, Codex app/CLI
...
[**Sponsor Olun →**](https://github.com/sponsors/mehmet-turac)
