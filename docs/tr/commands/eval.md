...
1. Şablonla `.codex/evals/feature-name.md` oluştur:
...
1. `.codex/evals/feature-name.md` dosyasından eval tanımını oku
2. Her capability eval için:
   - Kriteri doğrulamayı dene
   - PASS/FAIL kaydet
   - Denemeyi `.codex/evals/feature-name.log` dosyasına kaydet
