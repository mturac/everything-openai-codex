...
4. `.codex/commands/` dizininde komut dosyaları oluştur
5. `.codex/scripts/` dizininde script dosyaları oluştur
6. **Proje CODEX.md'yi PM2 bilgisiyle güncelle** (aşağıya bakın)
7. **Terminal komutlarıyla tamamlama özetini göster**

---

## Post-Init: CODEX.md'yi Güncelle

Dosyalar oluşturulduktan sonra, projenin `CODEX.md` dosyasına PM2 bölümünü ekle (yoksa oluştur):
