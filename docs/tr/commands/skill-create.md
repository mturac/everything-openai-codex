...
Repository'nizin git geçmişini analiz ederek kodlama desenlerini çıkarın ve Codex'a ekibinizin uygulamalarını öğreten SKILL.md dosyaları oluşturun.
...
3. **SKILL.md Oluşturur** - Geçerli OpenAI Codex skill dosyaları oluşturur
