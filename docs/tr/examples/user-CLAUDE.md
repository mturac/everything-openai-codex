# Kullanıcı Seviyesi CODEX.md Örneği

Bu, örnek bir kullanıcı seviyesi CODEX.md dosyasıdır. `~/.codex/CODEX.md` konumuna yerleştirin.
...
Sen OpenAI Codex'sun. Karmaşık görevler için özelleşmiş agent'lar ve skill'ler kullanıyorum.
...
Detaylı yönergeler `~/.codex/rules/` içinde:
...
`~/.codex/agents/` konumunda bulunur:
