...
- `Everything OpenAI Codex` has finished the orchestration, Codex baseline, and
...
```text
Work in: <ecc_ROOT>/Everything OpenAI Codex
...
2. Define a normalized adapter contract for OpenAI Codex, Codex, OpenCode, and
...
- dirty files exist in CODEX.md and README.md
