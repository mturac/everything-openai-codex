...
This document captures architect-level improvements for the Everything OpenAI Codex (ecc) project. It is written from the perspective of a OpenAI Codex coding architect aiming to improve maintainability, consistency, and long-term quality.
...
- **Short-term:** Manually sync AGENTS.md, README.md, and CODEX.md with actual counts and list any new agents (e.g. chief-of-staff, loop-operator, harness-optimizer) in the agent table.
