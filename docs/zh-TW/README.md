...
本頁是入口翻譯。最新操作細節請以儲存庫內維護的文件為準，不再依賴外部影片或貼文串。

| 文件 | 何時使用 |
|------|----------|
| [Hermes 設定](../HERMES-SETUP.md) | 設定 Hermes x ecc operator workflow |
| [rc.1 發布說明](../releases/2.0.0-rc.1/release-notes.md) | 了解目前公開 release surface |
| [跨 harness 架構](../architecture/cross-harness.md) | 在 harness 之間移植 skills、rules 和 adapters |
| [Token optimization](../token-optimization.md) | 調整 Codex model、compaction 和 cost 設定 |
| [Security guide](../../the-security-guide.md) | 檢查 sandboxing、hook risks 和 AgentShield |
...
ecc 來自日常 OpenAI Codex 使用，將重複的 production workflow 轉成可重用的 skills、hooks、rules 與 install profiles。
...
- **Hermes 設定：** [../HERMES-SETUP.md](../HERMES-SETUP.md)
- **發布說明：** [../releases/2.0.0-rc.1/release-notes.md](../releases/2.0.0-rc.1/release-notes.md)
- **安全指南：** [../../the-security-guide.md](../../the-security-guide.md)
- **來源致謝：** [../../NOTICE.md](../../NOTICE.md)
