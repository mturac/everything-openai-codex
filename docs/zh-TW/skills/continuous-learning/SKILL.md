...
description: Automatically extract reusable patterns from OpenAI Codex sessions and save them as learned skills for future use.
---

# 持續學習技能

自動評估 OpenAI Codex 工作階段結束時的內容，提取可重用模式並儲存為學習技能。
