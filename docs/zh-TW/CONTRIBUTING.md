# 貢獻 Everything OpenAI Codex

感謝您想要貢獻。本儲存庫旨在成為 OpenAI Codex 使用者的社群資源。
...
```bash
git clone https://github.com/YOUR_USERNAME/Everything OpenAI Codex.git
...
在提交前確保您的設定能與 OpenAI Codex 正常運作。
...
開啟 issue 或在 X 上聯繫：[@mehmet_turac](https://x.com/mehmet_turac)
