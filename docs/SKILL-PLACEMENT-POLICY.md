...
| Learned | `~/.codex/skills/learned/` | No | Required |
| Imported | `~/.codex/skills/imported/` | No | Required |
| Evolved | `~/.codex/homunculus/evolved/skills/` (global) or `projects/<hash>/evolved/skills/` (per-project) | No | Inherits from instinct source |
...
Location: `~/.codex/skills/learned/<skill-name>/`.
...
Location: `~/.codex/skills/imported/<skill-name>/`.
...
Location: `~/.codex/homunculus/evolved/skills/` (global) or `~/.codex/homunculus/projects/<hash>/evolved/skills/` (per-project).
...
`scripts/skills-health.js`, `scripts/lib/skill-evolution/health.js`, session hooks: they probe `~/.codex/skills/learned` and `~/.codex/skills/imported`. Missing directories are treated as empty; no errors.

## Publishable vs Local-Only

| Publishable | Local-Only |
|-------------|------------|
| `skills/*` (curated) | `~/.codex/skills/learned/*` |
