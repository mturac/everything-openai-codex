...
The repo is moving from a OpenAI Codex config pack into a cross-harness operating system for agentic work.
...
The practical shift: ecc is no longer just a OpenAI Codex config pack. It is becoming a cross-harness operating system for agentic work.
