...
**出力パス**: `.codex/PRPs/prds/{ケバブケース名}.prd.md`

必要に応じてディレクトリを作成する: `mkdir -p .codex/PRPs/prds`
...
**ファイル**: `.codex/PRPs/prds/{name}.prd.md`
...
実行: `/prp-plan .codex/PRPs/prds/{name}.prd.md`
