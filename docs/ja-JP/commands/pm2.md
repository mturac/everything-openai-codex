...
6. **プロジェクトのCODEX.md**をPM2情報で更新(下記参照)
...
ファイル生成後、プロジェクトの`CODEX.md`にPM2セクションを追加(存在しない場合は作成):
...
**Codexコマンド:** /pm2-all, /pm2-all-stop, /pm2-{port}, /pm2-{port}-stop, /pm2-logs, /pm2-status
