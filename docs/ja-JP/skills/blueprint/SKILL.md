...
4. **レビュー** — 敵対的なレビューを最強モデルサブエージェント（例：Deep）にチェックリストとアンチパターンカタログに対して委任。最終化する前にすべての重大な知見を修正。
...
このスキルはEverything OpenAI Codexに付属します。eccがインストールされている場合、別のインストールは必要ありません。
