...
description: OpenAI Codexセッションから再利用可能なパターンを自動的に抽出し、将来の使用のために学習済みスキルとして保存します。
---
...
- [The Longform Guide](https://x.com/mehmet_turac/status/2014040193557471352) - 継続学習に関するセクション
...
| 分析 | メインコンテキスト | バックグラウンドエージェント(Fast) |
| 粒度 | 完全なスキル | 原子的な「本能」 |
| 信頼度 | なし | 0.3-0.9の重み付け |
