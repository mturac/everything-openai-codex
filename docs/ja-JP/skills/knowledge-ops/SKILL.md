...
### レイヤー 2: OpenAI Codex メモリ（クイックアクセス）
- **パス:** `~/.codex/projects/*/memory/`
...
### 3. 保存
適切なレイヤーに書き込む:
- クイックアクセスのために常に OpenAI Codex メモリを更新する
...
- ソース: Codex セッションファイル、Codex セッション、その他のエージェントセッション
- 宛先: ナレッジベースリポジトリ
...
# 中期: プロジェクトメモリファイル
クロスセッション呼び出しのために ~/.codex/projects/*/memory/ に書き込む
