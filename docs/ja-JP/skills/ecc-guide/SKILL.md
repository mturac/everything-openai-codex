...
Use this skill when a user needs help understanding, navigating, installing, or choosing parts of Everything OpenAI Codex.
...
3. inspect existing `CODEX.md` and settings files
