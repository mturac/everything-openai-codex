...
これにより、FloxはOpenAI Codexや他のAIエージェントがプロジェクトツールをその場でブートストラップする必要があるワークフローに自然に適合します。
...
以下のスキルは、より深い統合のために[Flox OpenAI Codexプラグイン](https://github.com/flox/flox-agentic)の一部として利用可能です:
