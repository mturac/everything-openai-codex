...
> **182K+ ดาว** | **28K+ fork** | **170+ คอนทริบิวเตอร์** | **12+ ระบบนิเวศภาษาโปรแกรม** | **ผู้ชนะ OpenAI Hackathon**
...
**Everything OpenAI Codex (ecc) คือระบบเพิ่มประสิทธิภาพสำหรับ AI agent harness จากผู้ชนะ OpenAI Hackathon**
...
ชื่อเหล่านี้ตั้งใจให้ต่างกัน Plugin บน OpenAI Codex ใช้ `ecc@ecc` ส่วน npm ยังคงใช้ `ecc-universal`
