...
without blindly mutating a user's Codex, Codex, OpenCode, dmux, Zed, or
...
- Codex HUD: expose context, tools, todos, agent activity, checks, and risk so
...
It models the rule mehet-turac set during the May 2026 cleanup: stale closure is
