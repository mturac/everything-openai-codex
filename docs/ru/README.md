...
| [Security guide](../../the-security-guide.md) | Проверить sandboxing, hook risks и AgentShield |
...
> AgentShield — сопутствующая поверхность security-аудита для ecc. Текущую coverage проверяйте по тестам пакета и каталогу правил.
...
# Глубокий анализ с тремя агентами Deep 4.6
...
**Флаг `--deep`** запускает три агента Codex Deep 4.6 в pipeline red-team/blue-team/auditor. Атакующий ищет цепочки эксплойтов, защитник оценивает защиты, а аудитор синтезирует оба результата в приоритизированную оценку рисков. Это adversarial reasoning, а не просто matching паттернов.
