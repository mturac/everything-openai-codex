...
- The latest May 18 merge batch on `main` includes PR #1970 workflow-security
  ...
  OpenAI/AstraFlow provider response guards, and `80f6c279` provider-guard
...
- `docs/releases/2.0.0-rc.1/publication-evidence-2026-05-18.md` records the
  ...
  project `.codex` scan, Linear sync, work-items sync, operator dashboard
  refresh, PR #1976 provider-guard validation, and current-head CI success for
  `80f6c279`.
...
- GitHub CI run `26014623528` completed successfully for
  `80f6c27957cb2bee7614f093ec7237afd93c3c9f`, including Validate Components,
...
- AgentShield PR #87 merged as `26bb44650663816d07180e0d20c1895e431a326c`
  and added installed Codex plugin-cache runtime confidence. Cached plugin
  findings now emit `runtimeConfidence: plugin-cache`, non-secret score impact
  stays at the intended `0.5x`, repository-local non-Codex `plugins/cache`
...
- ecc-Tools PR #59 merged as `505b372dbd8f75f996d9e2ed079effd30cec5ba5`
  ...
  readiness, inspects capped Codex, Codex, OpenCode, MCP, plugin, and
...
- `docs/architecture/harness-adapter-compliance.md` maps OpenAI Codex, Codex,
...
- `docs/releases/2.0.0-rc.1/publication-readiness.md` gates GitHub release,
  npm dist-tag, Codex plugin, Codex plugin, OpenCode package, billing, and
...
- `docs/releases/2.0.0-rc.1/publication-evidence-2026-05-12.md` records the
  ...
  smoke, Codex plugin validation/tag preflight, Codex marketplace CLI shape,
...
- AgentShield PR #69 added the deterministic harness adapter registry. Scan
  reports now surface local marker evidence for OpenAI Codex, OpenCode, Codex,
...
- ecc-Tools PR #26 added cost/token-risk predictive follow-ups for AI routing,
  Codex/model calls, usage limits, quota, and analysis-budget changes that lack
...
- ecc-Tools PR #59 implemented the third job-specific hosted executor:
  ...
  gates to Codex, Codex, OpenCode, MCP, plugin, and cross-harness evidence
...
- ecc-Tools PR #78 merged as `0d4eb949aa56f56da88e6654273a22ffb95983a1`
  ...
  Codex, Codex, OpenCode, MCP, plugin, and cross-harness owners, and routed
...
- ecc PR #1816 salvaged the useful stale #1659 frontend design guidance into
  ...
  OpenAI `frontend-design` skill remains externally sourced.
...
| --- | --- | --- | --- |
| Keep public PRs below 20 | Repo-family PR recheck | 0 open PRs across `Everything OpenAI Codex`, AgentShield, JARVIS, `ecc-Tools/ecc-Tools`, and `ecc-Tools/ecc-website` on 2026-05-18 after merging PR #1976 and refreshing platform audit evidence | Complete |
| Keep public issues below 20 | Repo-family issue recheck | 0 open issues across `Everything OpenAI Codex`, AgentShield, JARVIS, `ecc-Tools/ecc-Tools`, and `ecc-Tools/ecc-website` on 2026-05-18 after the live platform audit refresh | Complete |
...
| Naming and rename readiness | Naming matrix across package/plugin/docs/social surfaces | `docs/releases/2.0.0-rc.1/naming-and-publication-matrix.md` records current package, repo, Codex plugin, Codex plugin, OpenCode, and npm availability evidence | Complete for rc.1; post-rc rename remains future work |
| Codex and Codex plugin publication | Contact/submission path with required artifacts and status | Publication readiness, naming matrix, and May 12 dry-run evidence document plugin validation, clean-checkout Codex tag/install smoke, and Codex marketplace CLI shape | Needs explicit approval for real tag/push and marketplace submission |
...
- `jarrodwatts/codex-hud` for always-visible status, tool, agent, todo, and
  context telemetry.
...
- `openais/codex`, active `sst/opencode` / `anomalyco/opencode`, Zed,
...
- Naming matrix covers product name, npm package, Codex plugin, Codex plugin,
...
- Release notes, migration guide, known issues, quickstart, X thread, LinkedIn
  ...
  exist.
- Plugin publication/contact paths for Codex and Codex are documented with
...
- Adapter matrix covers OpenAI Codex, Codex, OpenCode, Cursor, Gemini,
...
1. Continue the AgentShield enterprise control-plane sequence from
   ...
   packs; PR #87 classified installed Codex plugin caches separately from
