# Exemplo de CODEX.md no Nível de Usuário

Este é um exemplo de arquivo CODEX.md no nível de usuário. Coloque em `~/.codex/CODEX.md`.
...
Você é OpenAI Codex. Eu uso agentes e skills especializados para tarefas complexas.
...
Diretrizes detalhadas em `~/.codex/rules/`:
