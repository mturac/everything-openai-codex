...
> **140K+ estrelas** | **21K+ forks** | **170+ contribuidores** | **12+ ecossistemas de linguagem** | **Vencedor do Hackathon OpenAI**
...
**O sistema de otimização de desempenho para harnesses de agentes de IA. De um vencedor do hackathon da OpenAI.**
...
> Construído no OpenAI Codex Hackathon (Cerebral Valley x OpenAI, Fev 2026). 1282 testes, 98% de cobertura, 102 regras de análise estática.
