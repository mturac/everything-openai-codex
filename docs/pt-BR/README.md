...
/eoc:plan "Adicionar autenticação de usuário"
...
|----------|-----------------|--------------|
| Planejar um novo recurso | `/eoc:plan "Adicionar auth"` | planner |
| Projetar arquitetura de sistema | `/eoc:plan` + agente architect | architect |
...
```
/eoc:plan "Adicionar autenticação de usuário com OAuth"
