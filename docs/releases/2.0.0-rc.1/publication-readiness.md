...
| --- | --- | --- | --- | --- | --- | --- |
| Product name | Everything OpenAI Codex / EOC | `README.md`, `CHANGELOG.md`, release notes | `rg -n "Everything OpenAI Codex" README.md CHANGELOG.md docs/releases/2.0.0-rc.1` | `publication-evidence-2026-05-12.md` | Release owner | Evidence recorded |
...
| Codex plugin slug | `eoc` / `eoc@eoc` install path | `.codex-plugin/plugin.json`, `.agents/plugins/marketplace.json`, `.codex-plugin/marketplace.json` | `node tests/plugin-manifest.test.js` | `publication-evidence-2026-05-12.md` plus current repo validation | Plugin owner | Evidence recorded; slug refreshed from legacy `ecc` |
...
| Codex repo marketplace | `eoc@2.0.0-rc.1` exposed through `.agents/plugins/marketplace.json` | `.agents/plugins/marketplace.json`, `.codex-plugin/README.md` | `HOME="$(mktemp -d)" codex plugin marketplace add <local-checkout>` | `publication-evidence-2026-05-15.md` plus current repo validation | Plugin owner | Repo-marketplace path verified; official Plugin Directory publishing coming soon |
...
| Codex plugin | Manifest validates, marketplace JSON points to public repo, install docs match slug | `codex plugin validate .codex-plugin/plugin.json`; `codex plugin tag .codex-plugin --dry-run`; isolated temp-home install smoke | `Blocker: real tag creation/push requires approval` | Plugin owner | Clean-checkout dry-run and install smoke recorded |
