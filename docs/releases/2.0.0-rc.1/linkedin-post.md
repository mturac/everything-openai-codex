...
The practical shift is simple: ecc is no longer framed as only a OpenAI Codex plugin or config bundle.
...
- Codex, OpenCode, Cursor, Gemini, Zed, and OpenAI Codex surfaces that share the same core workflow layer
