...
- Updated the Codex plugin, Codex plugin, OpenCode package metadata, and release-facing docs to **1.10.0**.
...
- The Codex plugin remains constrained by platform-level `rules` distribution limits.
