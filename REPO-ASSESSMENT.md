...
This repository is now positioned as **Everything OpenAI Codex (ecc)**: an
...
- The public docs now explain the short `ecc@ecc` plugin identifier and warn
...
- Corrected release workflow copy so generated release notes advertise the
  canonical `ecc@ecc` plugin identifier.
