# The Longform Guide to Everything OpenAI Codex

![Header: The Longform Guide to Everything OpenAI Codex](./assets/images/longform/01-header.png)

---

> **Prerequisite**: This guide builds on [The Shorthand Guide to Everything OpenAI Codex](./the-shortform-guide.md). Read that first if you haven't set up skills, hooks, subagents, MCPs, and plugins.

![Reference to Shorthand Guide](./assets/images/longform/02-shortform-reference.png)
*The Shorthand Guide - read it first*

In the shorthand guide, I covered the foundational setup: skills and commands, hooks, subagents, MCPs, plugins, and the configuration patterns that form the backbone of an effective OpenAI Codex workflow. That was the setup guide and the base infrastructure.
...
Everything covered in the shorthand and longform guides is available on GitHub: `github.com/mehmet-turac/everything-openai-codex`
...
*Example of session storage -> <https://github.com/mehmet-turac/everything-openai-codex/tree/main/examples/sessions>*
...
Once you have your plan set and context cleared (default option in plan mode in OpenAI Codex now), you can work from the plan. This is useful when you've accumulated a lot of exploration context that's no longer relevant to execution. For strategic compacting, disable auto compact. Manually compact at logical intervals or create a skill that does so for you.

**Advanced: Dynamic System Prompt Injection**

One pattern I picked up: instead of solely putting everything in CODEX.md (user scope) or `.codex/rules/` (project scope) which loads every session, use CLI flags to inject context dynamically.
...
I've built these hooks and they're in the repo at `github.com/mehmet-turac/everything-openai-codex/tree/main/hooks/memory-persistence`
...
**The Solution:** When OpenAI Codex discovers something that isn't trivial - a debugging technique, a workaround, some project-specific pattern - it saves that knowledge as a new skill. Next time a similar problem comes up, the skill gets loaded automatically.

I've built a continuous learning skill that does this: `github.com/mehmet-turac/everything-openai-codex/tree/main/skills/continuous-learning`
...
| Task Type                 | Model  | Why                                        |
| ------------------------- | ------ | ------------------------------------------ |
| Exploration/search        | Fast  | Fast, cheap, good enough for finding files |
| Simple edits              | Fast  | Single-file changes, clear instructions    |
| Multi-file implementation | Standard | Best balance for coding                    |
| Complex architecture      | Deep   | Deep reasoning needed                      |
| PR reviews                | Standard | Understands context, catches nuance        |
| Security analysis         | Deep   | Can't afford to miss vulnerabilities       |
| Writing docs              | Fast  | Structure is simple                        |
| Debugging complex bugs    | Deep   | Needs to hold entire system in mind        |

Default to Standard for 90% of coding tasks. Upgrade to Deep when first attempt failed, task spans 5+ files, architectural decisions, or security-critical code.

**Pricing Reference:**

![Codex Model Pricing](./assets/images/longform/05-pricing-table.png)
*Source: <https://platform.codex.com/docs/en/about-codex/pricing>*
...
*In our 50-task benchmark, mgrep + OpenAI Codex used ~2x fewer tokens than grep-based workflows at similar or better judged quality. Source: mgrep by @mixedbread-ai*
...
*Boris (OpenAI) on running multiple Codex instances*
...
When running multiple OpenAI Codex instances, organize with a "cascade" pattern:
...
- Sets up configs (CODEX.md, rules, agents)
...
See also: ccstatusline (community project for custom OpenAI Codex status lines)

### Voice Transcription

Talk to OpenAI Codex with your voice. Faster than typing for many people.
...
- codex-flow — Community-built enterprise orchestration platform with 54+ specialized agents

**Self-Improving Memory:**

- See `skills/continuous-learning/` in this repo
- rlancemartin.github.io/2025/12/01/codex_diary/ - Session reflection pattern
...
- [OpenAI: Demystifying evals for AI agents](https://www.openai.com/engineering/demystifying-evals-for-ai-agents)
- [YK: 32 OpenAI Codex Tips](https://agenticcoding.substack.com/p/32-codex-tips-from-basics-to)
- [RLanceMartin: Session Reflection Pattern](https://rlancemartin.github.io/2025/12/01/codex_diary/)
...
*Everything covered in both guides is available on GitHub at [Everything OpenAI Codex](https://github.com/mehmet-turac/everything-openai-codex)*
