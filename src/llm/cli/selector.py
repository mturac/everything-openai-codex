...
def interactive_select(
    ...
    if providers is None:
        providers = [
            ("codex", "OpenAI Codex ( Sonnet, Opus, Haiku)"),
    ...
    if models_per_provider is None:
        models_per_provider = {
            "codex": [
                ("codex-opus-4-5", "Codex Opus 4.5 - Most capable"),
                ("codex-sonnet-4-7", "Codex Sonnet 4.7 - Balanced"),
                ("codex-haiku-4-7", "Codex Haiku 4.7 - Fast"),
            ],
            "openai": [
