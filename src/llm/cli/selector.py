...
def interactive_select(
    ...
    if providers is None:
        providers = [
            ("codex", "OpenAI Codex ( Standard, Deep, Fast)"),
    ...
    if models_per_provider is None:
        models_per_provider = {
            "codex": [
                ("codex-deep-4-5", "Codex Deep 4.5 - Most capable"),
                ("codex-standard-4-7", "Codex Standard 4.7 - Balanced"),
                ("codex-fast-4-7", "Codex Fast 4.7 - Fast"),
            ],
            "openai": [
