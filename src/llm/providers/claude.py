...
class CodexProvider(LLMProvider):
    ...
    def generate(self, input: LLMInput) -> LLMOutput:
        try:
            params: dict[str, Any] = {
                "model": input.model or "codex-sonnet-4-7",
            ...
            if input.max_tokens:
                ...
                params["max_tokens"] = 8192  # required by OpenAI API
            if input.tools:
            ...
            if "401" in msg or "authentication" in msg.lower():
                raise AuthenticationError(msg, provider=ProviderType.CODEX) from e
            if "429" in msg or "rate_limit" in msg.lower():
                raise RateLimitError(msg, provider=ProviderType.CODEX) from e
            if "context" in msg.lower() and "length" in msg.lower():
                raise ContextLengthError(msg, provider=ProviderType.CODEX) from e
            raise
