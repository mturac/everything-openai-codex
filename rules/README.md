...
>
> Use the ecc-owned namespace below for user-level Codex installs. Flat
...
cp -r rules/angular ~/.codex/rules/ecc/
cp -r rules/python ~/.codex/rules/ecc/
cp -r rules/golang ~/.codex/rules/ecc/
cp -r rules/web ~/.codex/rules/ecc/
cp -r rules/swift ~/.codex/rules/ecc/
cp -r rules/php ~/.codex/rules/ecc/
cp -r rules/ruby ~/.codex/rules/ecc/
cp -r rules/arkts ~/.codex/rules/ecc/
