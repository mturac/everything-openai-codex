#!/usr/bin/env python3
"""
ecc Dashboard - Everything OpenAI Codex GUI
...
class eccDashboard(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title("ecc Dashboard - Everything OpenAI Codex")
...
Usage: This skill is automatically activated when working with related technologies."""
    ...
    def create_commands_tab(self):
        ...
        ttk.Label(info_frame, text="Slash Commands for OpenAI Codex:", 
                  font=('Arial', 10, 'bold')).pack(anchor=tk.W)
        ttk.Label(info_frame, text="Use these commands in OpenAI Codex by typing /command_name", 
    ...
    def create_rules_tab(self):
        ...
        ttk.Label(info_frame, text="Coding Rules by Language:", 
                  font=('Arial', 10, 'bold')).pack(anchor=tk.W)
        ttk.Label(info_frame, text="These rules are automatically applied in OpenAI Codex", 
                  foreground='gray').pack(anchor=tk.W)
