...
```bash
mkdir -p .codex/PRPs/reports
```

Write report to `.codex/PRPs/reports/{plan-name}-report.md`:
...
```bash
mkdir -p .codex/PRPs/plans/completed
mv "$ARGUMENTS" .codex/PRPs/plans/completed/
```
...
### Artifacts
- Report: `.codex/PRPs/reports/{name}-report.md`
- Archived Plan: `.codex/PRPs/plans/completed/{name}.plan.md`
