---
description: Execute a multi-model implementation plan while preserving Codex as the only filesystem writer.
---
...
**If ace-tool MCP is NOT available**, use OpenAI Codex built-in tools as fallback:
