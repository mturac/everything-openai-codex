...
6. **Update project CODEX.md** with PM2 info (see below)
7. **Display completion summary** with terminal commands

---

## Post-Init: Update CODEX.md

After generating files, append PM2 section to project's `CODEX.md` (create if not exists):
