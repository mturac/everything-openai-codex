...
Use this command as a conversational map of Everything OpenAI Codex. It should help the user discover the right ecc surface for their task without dumping the entire README or stale catalog counts.
...
- `/security-scan` for Codex/OpenCode configuration security review
