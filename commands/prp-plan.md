...
Write the full plan document using the template below. Save to `.codex/PRPs/plans/{kebab-case-feature-name}.plan.md`.

Create the directory if it doesn't exist:
```bash
mkdir -p .codex/PRPs/plans
```
...
```
.codex/PRPs/plans/{kebab-case-feature-name}.plan.md
```
...
- **File**: .codex/PRPs/plans/{kebab-case-feature-name}.plan.md
- **Source PRD**: [path or "N/A"]
...
> Next step: Run `/prp-implement .codex/PRPs/plans/{name}.plan.md` to execute this plan.
```
