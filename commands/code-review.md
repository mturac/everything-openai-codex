...
1. **Project rules** — Read `CODEX.md`, `.codex/docs/`, and any contributing guidelines
2. **Planning artifacts** — Check `.codex/prds/`, `.codex/plans/`, `.codex/reviews/`, and legacy `.codex/PRPs/{prds,plans,reports,reviews}/` for context related to this PR
...
Create review artifact at `.codex/reviews/pr-<NUMBER>-review.md` unless the repo already uses legacy `.codex/PRPs/reviews/` for this workstream:
...
Artifacts:
  Review: .codex/reviews/pr-<NUMBER>-review.md
  GitHub: <PR URL>
