...
- `path` (optional): defaults to the current project. Use a `.codex/` path, a repo root, or a checked-in template directory.
...
- Scanner: <https://github.com/mehmet-turac/agentshield>
