...
Hookify creates rule files that integrate with OpenAI Codex's hook system to prevent unwanted behaviors.
...
Files are stored as `.codex/hookify.{name}.local.md`:
