...
```bash
# In OpenAI Codex interactive mode:
...
codex -p --model opus "$(cat agents/gan-planner.md)
...
codex -p --model opus "$(cat agents/gan-generator.md)
...
codex -p --model opus "$(cat agents/gan-evaluator.md)
