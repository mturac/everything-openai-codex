# User-Level CODEX.md Example

This is an example user-level CODEX.md file. Place at `~/.codex/CODEX.md`.
...
You are OpenAI Codex. I use specialized agents and skills for complex tasks.
